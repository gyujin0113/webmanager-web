...
export default function FeatureCard({ icon: Icon, title, description }: FeatureCardProps) {
  return (
    <div className="rounded-2xl p-5 sm:p-8 border border-brand-accent/15 h-full w-full bg-white/[0.02] shadow-[0_0_20px_rgba(37,99,235,0.08)] transition-all duration-300 ease-out [@media(hover:hover)]:hover:scale-105 hover:shadow-[0_0_30px_rgba(37,99,235,0.15)] hover:border-brand-accent/30">
